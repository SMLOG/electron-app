...
export async function getAllInd() {
  let resp = await getCacheData(null, "industry", async () => {
    ...
    for (let i = 0; i < resp.data.diff.length; i++) {
      ...
      let iurl = `http://push2.eastmoney.com/api/qt/clist/get?pn=1&pz=500&po=1&np=1&ut=b2884a393a59ad64002292a3e90d46a5&fltt=2&invt=2&fid=f62&fs=b:${indCode}&stat=1&fields=f12,f14,f2,f3,f62,f184,f66,f69,f72,f75,f78,f81,f84,f87,f204,f205,f124&rt=52437752&cb=callbacka&_=1573132586640`;
