  ...
  <div class="main">
            ...
            <div class="scklox">
              <div class="cnt">
                <p class="key">
                  <b>
                    <a
                      href="http://quote.eastmoney.com/600332.html"
                      target="_blank"
                    >
                ...
                <div class="cnt tof10">
                  <ul>
                    ...
                    <li class="e" style="width: 165px">
                      成交额：
                      <span class="jsszo" id="hq_6">{{ item.amount }}</span
                      >(万元)
                    </li>
                    <li class="f">
                      <span id="hq_7"></span>
    ...
    <div id="divBody">
      <div class="subnav">
        ...
        <samp>|</samp>
        <a id="radar" @click="goAnchor('radar')" class>雷达图</a>
      </div>
      ...
      <radar id="radar" v-if="item.code" :item="item" />
    </div>
  </div>
</template>
<script>
...
export default {
  ...
  components: { Main, DuPont, Balance, Percent, Radar },
