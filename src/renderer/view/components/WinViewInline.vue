<template>
  <div id="webview" :src="link" style="background-color:white;">
    <div @dblclick="dbclick" class="info" v-show="false">
      <span>{{ item.hy }}</span>
    ...
    <div id="hqMain">
      <section id="cn_hqdata" class="hq_hqdata" style="display: none;"></section>
...
import $ from "jquery";
import { loadScripts } from "@/lib/utils";
...
export default {
  ...
  mounted() {
    window.paperCode = "sz002048";
    setTimeout(() => {
      let loadscript = loadScripts([
        "/static/js/sf_sdk.js",
        "static/js2/IO.WebPush4.js",
        "static/js2/IO.WebPush4.js",
        "static/js2/HQ_DataApps.js?hsw=7.32",
        "static/js2/zepto.min.js",
        "static/js2/sf_sdk.js",
        "static/js2/sinaAppTKChart.js",
        "static/js2/cn2017.js?hsw=7.32",
      ]);
    }, 5000);
  },
  watch: {},
...
<style scoped src="./WinViewInline.css" />
