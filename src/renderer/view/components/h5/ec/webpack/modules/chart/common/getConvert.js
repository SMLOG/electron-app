    ...
    for (var i = 0; i < len; i++) {
        ...
        switch (type) {
            case "VAVERAGE":
                ...
                obj = [entity.time, v5, v10];
                data.push(obj);
                break;
            case "CMA":
                var a5 = typeof (entity.Average5) == "undefined" ? "-" : entity.Average5.toFixed(3) / 1;
                var a10 = typeof (entity.Average10) == "undefined" ? "-" : entity.Average10.toFixed(3) / 1;
                var a20 = typeof (entity.Average20) == "undefined" ? "-" : entity.Average20.toFixed(3) / 1;
                var a30 = typeof (entity.Average30) == "undefined" ? "-" : entity.Average30.toFixed(3) / 1;
...
//////////////////
// WEBPACK FOOTER
// ./modules/chart/common/getConvert.js
// module id = 8
// module chunks = 0