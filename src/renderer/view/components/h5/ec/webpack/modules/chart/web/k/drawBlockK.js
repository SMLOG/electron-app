...
drawBlockK.prototype.maxmin = function (maxin) {
    ...
    cc.stroke();
    cc.fillText(maxin.minprise, txtx, y - angle - fontsize / 2 + 1);
    cc.closePath();
    ...
    cc.lineTo(x2, coordinate.format(y + angle));
    cc.stroke();
    cc.fillText(maxin.maxprise, txtx, y + angle + fontsize / 2 - 1);
    cc.closePath();
    cc.restore()
...
//////////////////
// WEBPACK FOOTER
// ./modules/chart/web/k/drawBlockK.js
// module id = 70
// module chunks = 0