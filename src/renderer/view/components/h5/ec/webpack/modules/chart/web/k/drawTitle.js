...
module.exports = {
    ...
    titleK: function (kObj) {
        ...
        if (kObj.options.show.name) {
            var namecode = info.name + "[" + info.code + "]";
    ...
    titleIndex: function (kObj) {
        ...
        var padding = ops.padding;
        var color = ops.color;
        var stauts = kObj.stauts.indexh;

        var data = thisData.indexs[stauts] || [];
        ...
        for (var i = 0; i < keys.length; i++) {
            left += drawText(keys[i], data[i + 1], i);
        }
...
//////////////////
// WEBPACK FOOTER
// ./modules/chart/web/k/drawTitle.js
// module id = 33
// module chunks = 0