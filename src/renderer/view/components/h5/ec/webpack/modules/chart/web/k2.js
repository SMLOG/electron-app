...
var initParameter = require("./k2/init/initParameter");
var initLayer = require("./k2/init/initLayer");
var initIndexDOM = require("./k2/init/initIndexDOM");             // 指标dom
var initDrawRegion = require("./k2/init/drawRegion");

var dataFormat = require("./k2/dataFormat");
var dataSplit = require("./k2/dataSplit");
...
var drawGrid = require("./k2/drawGrid");
var drawlien = require("chart/common/drawLine");
var drawBlockK = require("./k2/drawBlockK");
var drawBlockTrading = require("./k2/drawBlockTrading");
var drawIndexsV = require("./k2/drawIndexsV");       // 指标5
var drawIndexsH = require("./k2/drawIndexsH");       // 指标H
var drawTitle = require("./k2/drawTitle");
var dopPoint = require("./k2/dotPoint");             // 打点
var dopPoint2 = require("./k2/dotPoint2");             // 打点
var drawCYQ = require("./k2/drawCYQ");          // 筹码分布
var dotPointFormat = require("./k2/dotPointFormat");     // 

var getConvert = require("chart/common/getConvert");     // 计算各种指标
var arrayExt = require("chart/common/arrayExtension");

var interactive = require("./k2/interactive");
var interactiveForIpad = require("./k2/interactiveForIpad");
var slidebar = require("./k2/sildebar");
var sildebarForIpad = require("./k2/sildebarForIpad");

var extend = require("chart/common/extend2");
var ext = require("lodash").merge;


var extensionAPI = require("./k2/extensionAPI");     // 扩展api的实现

var getDeviceType = require("../common/getDeviceType");

var cyq = require("../common/cyq");
var cqcx = require("../common/cqcx");       // 除权除息
// var setCode = require("./k2/setCode");
