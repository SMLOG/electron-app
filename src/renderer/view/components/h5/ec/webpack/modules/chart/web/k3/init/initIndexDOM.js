...
module.exports = {
    ...
    technology: function () {
        ...
        function createIndexItem(obj, isDefault) {
            ...
            dom.style.height = index.pb + "px";
            dom.style.lineHeight = index.pb + "px";
        ...
        for (var i = 0; i < indexs.length; i++) {
            if (indexs[i].name == _this.status.h) {
        ...
        function handle(e) {
            ...
            if (tgt.nodeName == "LI") {
                ...
                // if (dt == 1) {
                new drawIndexsH(_this).draw(dt);
                // } else {
                // dataSplit.slice.call(_this);
                // new drawIndexsH(_this).draw(_this.status.h, dt);
        ...
        ul.style.top = (index.top + index.h - index.pb) + "px";
        ul.style.height = index.pb + "px";
    ...
    miniMap: function () {
        ...
        var html = "<div class='__sb_left'></div><div class='__sb_right'></div>";
        slidebarHtml.innerHTML = html;
...
//////////////////
// WEBPACK FOOTER
// ./modules/chart/web/k3/init/initIndexDOM.js
// module id = 181
// module chunks = 0