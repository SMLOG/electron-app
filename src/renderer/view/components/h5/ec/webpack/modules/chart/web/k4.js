...
var initParameter = require("./k4/init/initParameter");
var initLayer = require("./k4/init/initLayer");
var initIndexDOM = require("./k4/init/initIndexDOM");             // 指标dom
var initDrawRegion = require("./k4/init/drawRegion");
var registered = require("./k4/registered");

var getdata = require("./k4/getdata");
var draw = require("./k4/draw");


var dataFormat = require("./k4/dataFormat");
var dataSplit = require("./k4/dataSplit");
...
var drawGrid = require("./k4/drawGrid");
var drawlien = require("chart/common/drawLine");
var drawBlockK = require("./k4/drawBlockK");
var drawBlockTrading = require("./k4/drawBlockTrading");
var drawIndexsV = require("./k4/drawIndexsV");       // 指标5
var drawIndexsH = require("./k4/drawIndexsH");       // 指标H
var drawTitle = require("./k4/drawTitle");
var dopPoint = require("./k4/dotPoint");             // 打点
var dopPoint2 = require("./k4/dotPoint2");             // 打点
var drawCYQ = require("./k4/drawCYQ");          // 筹码分布
var dotPointFormat = require("./k4/dotPointFormat");     // 

var getConvert = require("chart/common/getConvert");     // 计算各种指标
var arrayExt = require("chart/common/arrayExtension");

var interactive = require("./k4/interactive");
var interactiveForIpad = require("./k4/interactiveForIpad");
var slidebar = require("./k4/sildebar");
var sildebarForIpad = require("./k4/sildebarForIpad");

var extend = require("chart/common/extend2");
var ext = require("lodash").merge;

var loadimgs = require("./k4/loadimgs");

var extensionAPI = require("./k4/extensionAPI");     // 扩展api的实现

var getDeviceType = require("../common/getDeviceType");

var cyqmod = require("../common/cyq");
var cqcx = require("../common/cqcx");       // 除权除息
// var setCode = require("./k4/setCode");
