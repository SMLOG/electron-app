...
module.exports = {
    ...
    slice: function () {
        ...
        // 新的网格规则
        // var newDiff = ((info.KaxisMax - info.KaxisMin) * 0).toFixed(decimal) / 1;
        var newDiffTop =  (info.KaxisMax - info.KaxisMin) / drawRegion.k.h * kgap.top;
        var newDiffBottom =  (info.KaxisMax - info.KaxisMin) / drawRegion.k.h * kgap.bottom;
        if (newDiffTop <= 0) {
            newDiffTop = 0.01;
        }
        if (newDiffBottom <= 0) {
        ...
        info.newKAxisMax = info.KaxisMax + newDiffTop;
        info.newKAxisMin = info.KaxisMin - newDiffBottom;
...
//////////////////
// WEBPACK FOOTER
// ./modules/chart/web/k4/dataSplit.js
// module id = 18
// module chunks = 0