...
slideBar.prototype.getData2 = function () {
    ...
    var da = kObj.sdata.kdata;

    var lasttime = da[da.length - 1][0];
    var endtime;
    if (maps.length > 0) {
        var frist = maps[0].split(",")[0];
        endtime = frist.substr(0,10).replace(/-/g, "") - 10000;     // 时间往前推一年防止断掉
    } else {
        endtime = 20110101;
    }


    var day = (lasttime + "").substr(0, 10).replace(/-/g, "");
    day = day / 1;
...
//////////////////
// WEBPACK FOOTER
// ./modules/chart/web/k4/sildebar.js
// module id = 90
// module chunks = 0