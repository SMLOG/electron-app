...
drawIndexsH.prototype.draw = function (type, dt) {
    ...
    var sinfo = ko.sdata.k.info;

    var data = ko.options.scale.indexs[type];

    // console.log("dddddddddddddddddddddddddddddddddd: " + type);
...
drawIndexsH.prototype.tip = function (txt, index) {
    ...
    if (txt) {
        ...
        //     window.open(urls[index].replace("{{code}}", info.code))
        // }
...
//////////////////
// WEBPACK FOOTER
// ./modules/chart/web/k5/drawIndexsH.js
// module id = 107
// module chunks = 0