...
var initParameter = require("./init/initParameter");
var initLayer = require("./init/initLayer");
var initIndexDOM = require("./init/initIndexDOM");             // 指标dom
var initDrawRegion = require("./init/drawRegion");
...
var drawIndexsV = require("./drawIndexsV");       // 指标5
var drawIndexsH = require("./drawIndexsH");       // 指标H
var drawTitle = require("./drawTitle");
var dopPoint = require("./dotPoint");             // 打点
var dopPoint2 = require("./dotPoint2");             // 打点
var drawCYQ = require("./drawCYQ");          // 筹码分布
...
var interactiveForIpad = require("./interactiveForIpad");
var slidebar = require("./sildebar");
var sildebarForIpad = require("./sildebarForIpad");

var extend = require("chart/common/extend2");
var ext = require("lodash").merge;


var extensionAPI = require("./extensionAPI");     // 扩展api的实现
