...
module.exports = function (index) {
    ...
    // k线的最值
    var kMax = scale.info.kMax;
    var kMin = scale.info.kMin;

    var KaxisMax = scale.info.KaxisMax;
    var KaxisMin = scale.info.KaxisMin;

    // 轴最值
    var newKAxisMax = scale.info.newKAxisMax;
    var newKAxisMin = scale.info.newKAxisMin;
    var axisDiff = newKAxisMax - newKAxisMin;

    // console.log(this.cyqCalc);
    index = index === undefined ? scale.end : index;
    ...
    var width = cyq.width;
    var height = drawRegion.k.h - drawRegion.k.mb - drawRegion.k.mt;
    ...
    for (var i = len - 1; i >= 0; i--) {
        ...
        if (xd != Infinity) {
            ...
            dy = sy + (newKAxisMax - yd) / axisDiff * height;
...
//////////////////
// WEBPACK FOOTER
// ./modules/chart/web/k2/drawCYQ.js
// module id = 14
// module chunks = 0