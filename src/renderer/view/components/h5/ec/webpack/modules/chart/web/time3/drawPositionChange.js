...
var tred = ["火箭发射", "封涨停板", "机构买单", "快速反弹", "大笔买入", "有大买盘", "向上缺口", "竞价上涨", "高开5日", "60日新高", "打开跌停", "60日大幅上涨"];
var tgrn = ["快速下跌", "封跌停板", "机构卖单", "高台跳水", "大笔卖出", "有大卖盘", "向下缺口", "竞价下跌", "低开5日", "60日新低", "打开涨停", "60日大幅下跌"];
...
function drawPositionChange() {
    ...
    var maxCD = Math.floor( (areaTime.height - 6) / 4 );        // 根据高度计算最高重跌个数
    console.log("maxCD" + maxCD);
...
function drawIcon3(ui, container, x, y, imgUrl, info, isFrist, index, _this) {
    ...
    if (isFrist) {
        div.className = "timePositionChangesAni";
    }
    ...
    div.addEventListener("mouseover", function () {
        document.querySelectorAll(".__positionChangePop").forEach(function(item, index){
            ui.removeChild(item);
        });
...
//////////////////
// WEBPACK FOOTER
// ./modules/chart/web/time3/drawPositionChange.js
// module id = 323
// module chunks = 0