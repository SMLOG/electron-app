    ...
    return new function() {
        ...
        var r = {
            ...
            US: {
                ...
                DAYK_RE_URL: "https://finance.sina.com.cn/us_stock/company/reinstatement/$symbol/$dirfq.js",
                RE_VAR: "$symbol$dirfq"
            },
            option_cn: {
            ...
            MSCI: {
                DAYK_URL: "http://quotes.sina.cn/msci/api/jsonp.php/$cb/MSCIService.getDayLine?symbol=$symbol"
            }
        };
        r.REPO = r.CN;
        var l = function() {
...
;xh5_define("chart.h5k", ["cfgs.settinger", "utils.util", "utils.painter"], function(e, t, n) {
    ...
    function a(a) {
        function i(e, n) {
            ...
            this.hq = void 0,
            this.nco = void 0;
            var y, N, w, S = new k(this,e), A = e.name;
