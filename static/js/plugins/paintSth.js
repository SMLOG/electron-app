xh5_define("plugins.paintSth", [], function() {
    ...
    var c, f = r(), d = 10, p = function() {
        ...
        t.fromPoints = function(t, a, n) {
            if (0 !== t.length) {
                var r, o = t[0], s = o[0], h = o[0], l = o[1], u = o[1];
        ...
        return t.fromCubic = function(t, a, n, r, o, s, h, c, f, d) {
            var p, y = v.cubicExtrema, g = v.cubicAt, m = y(t, n, o, h, l);
            for (f[0] = 1 / 0,
            f[1] = 1 / 0,
            d[0] = -(1 / 0),
            d[1] = -(1 / 0),
        ...
        return d.prototype = {
            ...
            _dashedLineTo: function(t, e) {
                var i, a, n = this._dashSum, s = this._dashOffset, h = this._lineDash, u = this._ctx, c = this._xi, f = this._yi, d = t - c, p = e - f, v = l(d * d + p * p), y = c, g = f, m = h.length;
                for (d /= v,
                p /= v,
                0 > s && (s = n + s),
                s %= n,
            ...
            _dashedBezierTo: function(t, e, i, a, n, r) {
                var o, s, h, u, c, f = this._dashSum, d = this._dashOffset, p = this._lineDash, y = this._ctx, g = this._xi, m = this._yi, x = v.cubicAt, w = 0, _ = this._dashIdx, T = p.length, S = 0;
                for (0 > d && (d = f + d),
                d %= f,
                o = 0; 1 > o; o += .1)
        ...
        y.prototype = {
            ...
            drawPath: function(t) {
                if (this.layout && !(this.layout.length < 2)) {
                    var e, i, a, n, r = this.layout, o = r[0][0], s = r[0][1], h = r[1][0], l = r[1][1], u = (l - s) / (h - o), c = s - u * o, f = this.paintTool.showCanvas.height, d = this.paintTool.showCanvas.width;
                    switch (!0) {
                    case u == -(1 / 0):
                    case u == 1 / 0:
                        e = o,
        ...
        S.prototype = {
            ...
            drawPath: function(t) {
                if (this.layout && !(this.layout.length < 2)) {
                    var e, i, a = this.layout, n = a[0][0], r = a[0][1], o = a[1][0], s = a[1][1];
                    a[2] && (e = a[2][0],
                    i = a[2][1]),
                    t.moveTo(n, r),
                    t.lineTo(o, s),
        ...
        L.prototype = {
            ...
            drawPath: function(t) {
                if (this.layout && !(this.layout.length < 2)) {
                    var e, i, a, n, r = this.layout, o = r[0][0], s = r[0][1], h = r[1][0], l = r[1][1];
                    r[2] && (e = r[2][0],
                    i = r[2][1],
                    a = r[2][0] - r[1][0] + r[0][0],
                    n = r[2][1] - r[1][1] + r[0][1]),
        ...
        C.prototype = {
            ...
            drawPath: function(t) {
                if (this.layout && !(this.layout.length < 2)) {
                    var e, i, a, n, r, o, s = this.layout, h = s[0][0], l = s[0][1], u = s[1][0], c = s[1][1], f = (c - l) / (u - h), d = l - f * h, p = this.paintTool.showCanvas.height, v = this.paintTool.showCanvas.width;
                    s[2] && (e = s[2][0],
                    i = s[2][1],
                    a = s[2][0] - s[1][0] + s[0][0],
                    n = s[2][1] - s[1][1] + s[0][1]),
        ...
        A.prototype = {
            ...
            drawPath: function(t, e) {
                if (this.layout && !(this.layout.length < 2)) {
                    var i, a = this.points, n = this.paintTool, r = this.paintTool.param, o = r.width, s = r.height, h = a[0][0], l = a[1][0] - a[0][0], u = h;
                    do
                        i = n._index2X(u),
                        t.moveTo(i, 0),
                        t.lineTo(i, s),
                        u += l;
                    while (0 > l && i > 0 || l > 0 && o > i);if (!e) {
                        var c = t.getContext()
                        ...
                        do
                            ...
                            u += l;
                        while (0 > l && i > 0 || l > 0 && o > i);c.restore()
                    }
                }
            }
        },
        ...
        B.prototype = {
            ...
            drawPath: function(t) {
                if (this.layout && !(this.layout.length < 2)) {
                    var e, i = this.layout, a = i[0][0], n = i[1][0], r = this.paintTool, o = this.paintTool.param, h = o.height, l = o.data, u = o.xScale, c = o.zoom[0], f = Math.floor(a / u), d = Math.floor(n / u), p = Math.abs(d - f) + 1;
        ...
        R.prototype = {
            ...
            drawPath: function(t, e) {
                if (this.layout && !(this.layout.length < 2)) {
                    ...
                    t.lineTo(r, a),
                    !e) {
                        var s, h, l, u, c, f = t.getContext(), d = (this.style.lineWidth || 1) / 2, p = this.points[0][1], v = this.points[1][1], y = this.points[0][0], g = this.points[1][0], m = Math.atan2(n - a, o - r), x = Math.abs(m / Math.PI * 180), w = Math.min(Math.abs(o - r), Math.abs(n - a), 15);
                        x > 90 && (x = 180 - x),
                        u = v > p ? d : -d,
                        c = g > y ? d : -d,
                        f.save(),
    ...
    return S.prototype = {
        ...
        _addPaintEvent: function() {
            ...
            function s(r) {
                ...
                if (0 == r.which || 1 == r.which || 3 == r.which) {
                    var s, u = L._curPaintTool, c = L._painting, f = L._draggedShape;
                    if (g = a(r, C),
                    y = L._getIndexAndValue(g),
                    f)
                        f.display = !0,
            ...
            var h, l, u, c, f, d, p, v, y, g, m, x, _, S, P, L = this, b = this.param, C = this.interactCanvas, k = this.interactCtx, M = this.showCtx, D = !1, A = L.getCurrentShapeList();
        ...
        save2LocalStorage: function(t) {
            var e, a = window.localStorage, n = this.param;
        ...
        addShapeList: function(t, i, a, n, r) {
            var o, s, h, l = this.shapeList, u = t || this.param.shapeListName;
            !l[u] && (l[u] = {}),
            o = l[u],
            !o[i] && (o[i] = []),
            s = o[i];
