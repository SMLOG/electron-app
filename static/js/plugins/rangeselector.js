            ...
            D = new function() {
                ...
                function E() {
                    ...
                    for (var s = {
                            ...
                            mU: function() {
                                this.iEnd(),
                                    f ? (a.removeHandler(document, "mousemove", b),
                                        a.removeHandler(document, "mouseup", r.onmouseup || function() {})) : (a.removeHandler(window, "mousemove", b),
                        ...
                        f ? a.addHandler(n, u[l], r["on" + u[l]] || function() {}) : a.addHandler(n, u[l], s);
                    this.body = n,
                        this.getX = function() {
                ...
                function I() {
                    ...
                    for (var r = {
                            ...
                            mU: function() {
                                this.iEnd(),
                                    f ? (a.removeHandler(document, "mousemove", b),
                                        a.removeHandler(document, "mouseup", u.onmouseup || function() {})) : (a.removeHandler(window, "mousemove", b),
                        ...
                        f ? a.addHandler(s, l[c], u["on" + l[c]] || function() {}) : a.addHandler(s, l[c], r);
                    this.body = s,
                        this.getX = function() {
