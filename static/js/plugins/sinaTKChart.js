        ...
        d = new (function() {
          ...
          (this.activeTab = function() {
            ...
            (this.drawTabs = function(r) {
              ...
              0 > h ? (h = 0) : h >= d && (h = e), (e = h);
              for (
                var f, p = Math.min(d, h + s), v = p - h;
                a.childNodes.length < v;
  ...
  function t(t) {
    ...
    var b = t.user_obj.settingCfg,
      ...
      g = {
        ...
        clsStyle: {
          cnnormal:
            "{width:39px;height:25px;line-height:25px;margin-top:3px;float:left;background:#EFF5FF;border:1px solid #EFF5FF;color:#08237a;text-align:center;font-size:12px;cursor:pointer;}",
          normal:
            "{width:43px;height:25px;line-height:25px;margin-top:3px;float:left;background:#EFF5FF;border:1px solid #EFF5FF;color:#08237a;text-align:center;font-size:12px;cursor:pointer;}",
          active:
            "{background-color:#ffffff;border-top:2px solid #062784;border-left:1px solid #dde4f4;border-right:1px solid #dde4f4;border-bottom:1px solid #ffffff;cursor:pointer;}",
          active_a:
            "{border-bottom:2px #3990e6 solid;display:inline-block;color:#3990e6;}",
          edage:
            "{width:100%;height:30px;border-top: 1px solid #dde4f4;border-bottom: 1px solid #dde4f4;background-color: #EFF5FF;position: relative;z-index: 233;}",
          rek:
            "{list-style:none;border:1px solid #dde4f4;margin-bottom:-1px;height:23px;line-height:23px;text-align:center;cursor:pointer;background-color:#EFF5FF;}"
        }
      },
      k = {
        normal:
          "{height:35px;line-height:35px;position:relative;float:left;background:#ffffff;border:1px solid #ffffff;color:#1a1a1a;text-align:center;font-size:14px;cursor:pointer;}",
        active:
          "{background-color:#ffffff;color:#3990e6;border-left:1px solid #ffffff;border-right:1px solid #ffffff;cursor:default;}",
        active_a:
          "{border-bottom:2px #3990e6 solid;margin-bottom:-2px;display:inline-block;color:#3990e6;}",
        edage:
          "{width:100%;height:37px;border-top: 1px solid #dde4f4;border-bottom: 1px solid #dde4f4;background-color: #ffffff;position: relative;z-index: 233;font-weight:bold;}",
        rek:
          "{list-style:none;border:1px solid #f0f0f0;margin-bottom:-1px;height:33px;line-height:33px;text-align:center;cursor:pointer;background-color:#f0f0f0;color:#1a1a1a;}",
        more:
          '{position: absolute;width: 13px;height: 9px;background-image:url("//www.sinaimg.cn/cj/finance_images/ua_ico.png");float: left;top:50%;margin-top:-4px;left: 50%;margin-left: 12px;}',
    ...
    var k = function() {
          ...
          (this._show = function() {
            if (null != this._elementContainer) {
              if (
                ...
                for (
                  var e = document.getElementsByTagName("select"), t = 0;
                  t < e.length;
                  t++
                )
      ...
      y = {
        ...
        clsStyle: {
          ...
          label:
            "{float:left;color:#1a1a1a;font-family:Microsoft Yahei,Arial;font-weight:bold;padding:0;margin:0;}",
          alert:
            "{position:absolute;display:none;top:-30px; height:25px;line-height:25px;color:#ff0000; padding-left:5px; width:190px;left:60px;border:1px solid #ccc;background:#fff;}",
          panel: "{float:left;}",
          popup: "{float:left;display:none;}",
          input:
            "{float:left;width:396px;color:#969696;font-family:Microsoft Yahei,Arial;}",
          list:
            "{height:25px; background:#FFFFFF; line-height:24px; text-align:center;margin-left:55px; display:none;}",
          dellist:
            "{background:url(//www.sinaimg.cn/cj/yw/img/bg_compare.png) #fff no-repeat 2px -20px; float:left; cursor:pointer; margin:2px 5px 2px 0;width:18px;height:18px;border:1px solid #c4cbcf;}",
          item:
            "{ float:left;margin-right:30px;margin-bottom:3px;font-size:13px;line-height:24px;text-align:center;color:#f69931;cursor:pointer;}",
          button:
            "{float:left;width:50px;text-align:center;background-color:#efefef;margin-right:2px;cursor:pointer;margin-left:1px;}",
          more:
            "{float:left;width:50px;text-align:center;background-color:#efefef;margin-right:2px;cursor:pointer;margin-left:1px;display:none;}",
          button_a:
            "{display:inline-block;width:50px;border:1px solid #d5d5d5;}",
        ...
        weiboclsStyle: {
          ...
          label:
            "{float:left;color:#1a1a1a;font-family:Microsoft Yahei,Arial;font-weight:bold;padding:0;margin:0;}",
          alert:
            "{position:absolute;display:none;top:-30px; height:25px;line-height:25px;color:#ff0000; padding-left:5px; width:190px;left:36px;border:1px solid #ccc;background:#fff;}",
          panel: "{float:left;}",
          popup: "{float:left;display:none;}",
          input:
            "{float:left;width:396px;color:#969696;font-family:Microsoft Yahei,Arial;}",
          list:
            "{height:25px; background:#FFFFFF; line-height:24px; text-align:center;/*margin-left:55px;*/ display:none;}",
          dellist:
            "{background:url(//www.sinaimg.cn/cj/yw/img/bg_compare.png) #fff no-repeat 0px -22px; float:left; cursor:pointer; margin:4px 1px 2px 1px;width:14px;height:14px;border:1px solid #c4cbcf;}",
          item:
            "{ float:left;margin-right:10px;margin-bottom:3px;font-size:13px;line-height:24px;text-align:center;color:#f69931;cursor:pointer;}",
          button:
            "{float:left;width:50px;text-align:center;background-color:#efefef;margin-right:2px;cursor:pointer;margin-left:1px;}",
          more:
            "{float:left;width:50px;text-align:center;background-color:#efefef;margin-right:2px;cursor:pointer;margin-left:1px;display:none;}",
  ...
  function sinaTKChart(configObj) {
    ...
    (this.showView = function(t) {
      ...
      (this.onresize = function() {
        _tChart && _tChart.resize(), S && S.resize(), sinaTKChartObj.resizePaintTool();
      }),
