xh5_define("plugins.techcharts", ["utils.util", "utils.painter"], function (utils_util, utils_painter) {
    ...
    function pChart(i) {
                ...
                , l = function (a) {
                    if (a) {
                        ...
                        if (s) {
                            ...
                            if (!h) {
                                if (!utils_util.isFunc(PCHART_MAP[s]))
                                    return;
        ...
        var a, stockData = i.stockData, iMgr = i.iMgr, titleArea = i.titleArea, chartArea = i.chartArea, cb = i.cb, cfg = i.cfg, type = i.type, usrObj = i.usrObj, m = [], g = {
            edit: function (t) {
                a.createChart(t)
            },
            remove: function (t) {
        ...
        var r = Object.prototype.toString
            ...
            , calcSTD = function (t, i) {
                for (var r = [], a = 0, s = t.length; s > a; a++)
                    r.push(i > a ? calcSD(t.slice(0, a + 1), 1) : calcSD(t.slice(a - i + 1, a + 1), 1));
                return r
            }
            , A = function (t) {
        ...
        var auth = function (t) {
            var i = function () {
                for (var t, linkItem, r = {
                    ...
                    a: r
                }], href = document.location.href, e = links.length; e--;)
                    if (linkItem = links[e],
                        0 === href.indexOf(linkItem.h)) {
                        t = linkItem.a;
                        break
                    }
                return t
