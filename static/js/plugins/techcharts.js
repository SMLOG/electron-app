xh5_define("plugins.techcharts", ["utils.util", "utils.painter"], function(utils_util, utils_painter) {
    ...
    function DITC(i, a, s) {
        ...
        var o, l, n = "#c2c2c2",
            c = !0,
            d = "https://stock.sina.com.cn/stock/api/openapi.php/StockLevel2Service.getSummarize?symbol=$symbol&type=0&callback=$cb&dpc=1&retcode=0",
            f = i.DIMENSION.w_t / 2;
            ...
            this.draw = function(r, a) {
                ...
                if (this.__iOffsetX = isNaN(a) ? this.__iOffsetX : a,
                    ...
                    var l, n, c, d = this.viewState.start,
                        ...
                        u = utils_util.hex2dec(this.customArr[0].color, .5),
                        p = utils_util.hex2dec(this.customArr[1].color, .5);
                    c = d,
                        n = this.datas[0].flag;
                    for (var v = d; f > v; v++)
    ...
    function pChart(i) {
        ...
        var a, stockData = i.stockData,
            iMgr = i.iMgr,
            titleArea = i.titleArea,
    ...
    function tChart(options) {
        ...
        var o, f, stockData = options.stockData,
            iMgr = options.iMgr,
        ...
        var ot, techChartList, nt, ct = "BLANKCTN",
            dt = function() {
