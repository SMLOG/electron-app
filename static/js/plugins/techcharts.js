xh5_define("plugins.techcharts", ["utils.util", "utils.painter"], function(utils_util, utils_painter) {
    "use strict";
    ...
    function ADL(i, a) {
        ...
        this.draw = function() {
            if (this.datas) {
                ...
                for (var r, a, h, o = this.datas.length, l = i.DIMENSION.w_t / o, n = l * gt, c = .5 * this.h, d = 0; 2 > d; d++) {
                    a = l * gt,
                    t.beginPath();
                    for (var f = 0; o > f && (r = this.datas[f],
                    !(r.ignore_price < 0)); f++)
                        h = r.adly,
    ...
    function ASI(i, a) {
        ...
        var s = bt.calcREF
          ...
          , c = bt.operateArr;
        this.initAndCalcAll = function(i) {
            for (var r = this.customArr, a = r[0].v, d = r[1].v, f = n(i, "close"), u = n(i, "high"), p = n(i, "low"), v = n(i, "open"), A = s(f, 1), m = e(c(u, A, "-")), g = e(c(p, A, "-")), b = e(c(u, s(p, 1), "-")), y = e(c(A, s(v, 1), "-")), _ = [], w = 0, D = m.length; D > w; w++)
                _.push(m[w] > g[w] && m[w] > b[w] ? m[w] + g[w] / 2 + y[w] / 4 : g[w] > b[w] && g[w] > m[w] ? g[w] + m[w] / 2 + y[w] / 4 : b[w] + y[w] / 4);
    ...
    function o(i, a) {
        ...
        this.draw = function(r, a) {
            function s(t, i, r) {
                for (var a = t.length, s = t[a - 1][i], e = a - 1, h = t.length; h--; ) {
                    var o = t[h][i];
                    r ? o > s && (s = o,
                    e = h) : s > o && (s = o,
                    e = h)
            ...
            this.datas) {
                ...
                for (var h, o, l, n = bt.calcREF, c = bt.getArr, d = c(this.selfArr, "m"), f = n(d, 1), u = this.viewState.start, p = this.viewState.end, v = utils_util.hex2dec(this.customArr[0].color, .5), A = utils_util.hex2dec(this.customArr[1].color, .5), m = u; p > m; m++) {
                    if ("undefined" == typeof h && (h = d[m] - f[m] >= 0 ? 1 : -1,
                    o = h,
                    l = m),
                    h = d[m] - f[m] >= 0 ? 1 : -1,
                    m == p - 1 && (h = -o),
                    h != o) {
                        ...
                        var g;
                        -1 == h ? (g = s(this.oriArr.slice(l, m + 1), "high", !0) + l,
                        e.lineTo(this.oriArr[g].ix, this.oriArr[g].hy),
                        e.newFillStyle([v])) : (g = s(this.oriArr.slice(l, m + 1), "low", !1) + l,
    ...
    function f(i, a, s) {
        ...
        var e = "chip_";
        this.selfDataUrlUpdate = "http://" + dt + ".sinajs.cn/etag.php?_=" + (new Date).getTime() + "&list=" + e + "$symbol",
        this.toReCalc = !0,
        this.loadedFlag = {},
            ...
            if (t && i && !(i.length < 1)) {
                ...
                if (t = t[0])
                    if (lt.stbd(t.date, a.date))
                        for (var s in t)
                            t.hasOwnProperty(s) && "undefined" != typeof a[s] && (a[s] = t[s]);
                    else
                        t.date > a.date && this.newData(i, t, r)
            }
        }
        ,
        ...
        this.initAndCalcAll = function(i) {
            ...
            this.urlData && this.toReCalc) {
                ...
                !this.datas && (this.datas = []),
                utils_util.ca(this.selfArr);
                for (var r, a = this.urlData.day, s = utils_util.kUtil.adbd(a, i, !1, !1), e = 0, h = i.length; h > e; e++)
                    r = s[e],
                    this.selfArr.push({
    ...
    function u(i, a, s) {
        ...
        this.name = "DITC",
        this.cb = s;
        var o, l, n = "#c2c2c2", c = !0, d = "https://stock.sina.com.cn/stock/api/openapi.php/StockLevel2Service.getSummarize?symbol=$symbol&type=0&callback=$cb&dpc=1&retcode=0", f = i.DIMENSION.w_t / 2;
        this.loadUrlData = function(i) {
            if (i) {
                var r = h.symbol
                  , a = "_" + r + lt.ddt(new Date).getFullYear();
                h.selfDataUrl = d,
                utils_util.load(h.selfDataUrl.replace("$symbol", r).replace("$cb", "var%20" + a + "="), function() {
                    var t = window[a];
        ...
        this.initAndCalcAll = function() {
            ...
            utils_util.ca(this.selfArr),
            h.urlData)) {
                var i, r, a, s = 0, o = h.urlData.length;
                for (i = 0; o > i; i++)
        ...
        this.draw = function() {
            if (this.datas) {
                ...
                if (4 == r || 5 == a) {
                    var s, e = h.selfArr.length, o = i.DIMENSION.h_t / e, l = Math.min(.6 * o, 2);
    ...
    function DMI(i, a) {
        ...
        var s = bt.calcEMA
          ...
          , n = bt.operateArr;
        this.initAndCalcAll = function(i) {
            for (var r, a, c = this.customArr[0].v, d = this.customArr[1].v, f = l(i, "close"), u = l(i, "high"), p = l(i, "low"), v = s(e(e(n(u, p, "-"), h(n(u, o(f, 1), "-"))), h(n(p, o(f, 1), "-"))), c), A = n(u, o(u, 1), "-"), m = n(o(p, 1), p, "-"), g = [], b = [], y = 0, _ = A.length; _ > y; y++)
                r = A[y],
                a = m[y],
                g.push(r > 0 && r > a ? r : 0),
                b.push(a > 0 && a > r ? a : 0);
        ...
        this.setRange = function() {
            if (this.datas) {
                ...
                for (; this.datas.length < r; )
                    this.datas.push({});
                for (var a = Number.MAX_VALUE, h = -Number.MAX_VALUE, o = 0, l = 0, n = this.selfArr[t].flag, c = bt.calcA, d = bt.getArr, f = 10, u = t; i > u; u++) {
        ...
        this.draw = function(r, a) {
            ...
            this.datas) {
                var s = i.DIMENSION.w_k / Math.max(this.datas.length, i.PARAM.minCandleNum)
                  , e = this.line;
                e.clear(!0, i.PARAM.getHd());
                for (var h, o, l, n, c, d = this.viewState.start, f = this.viewState.end, u = utils_util.hex2dec(this.customArr[0].color), p = utils_util.hex2dec(this.customArr[1].color), v = 0; 2 > v; v++) {
                    ...
                    l = d; f > l; l++) {
                        ...
                        if (h == v && l != f - 1)
                            h != o ? (e.beginPath(),
                            e.moveTo(g, this.datas[l - d].mny + b)) : e.lineTo(g, this.datas[l - d].mny + b);
                        else if (l != d && h != o && l != f - 1 || l == f - 1 && (h == o && h == v || h != o && h != v)) {
                            var y;
                            for (l == f - 1 && h == o ? (y = l,
                            e.lineTo(g, this.datas[l - d].mny + b)) : y = l - 1; y >= d; ) {
    ...
    function DPDKS(t, i, r) {
        ...
        this.drawCalc = function() {
            if (this.datas) {
                this.setRange();
                var t, i, r, s, e = this.datas.length, h = Number.MAX_VALUE, o = -Number.MAX_VALUE;
                for (i = 0; e > i; i++)
                    for (t = this.datas[i],
        ...
        this.draw = function(t, i) {
            ...
            this.datas) {
                ...
                this.line.stroke();
                for (var a, s = this.datas.length, e = this.cfg.DIMENSION.w_k / Math.max(s, this.cfg.PARAM.minCandleNum), h = this.customArr.length; h--; ) {
                    var o = this.customArr[h].prop + "y";
                    a = this.__iOffsetX - e * mt,
                    this.line.newStyle(this.customArr[h].color, !0, 1.5);
                    for (var l, n = 0; s > n && (l = this.datas[n][o],
                    !isNaN(l)); n++)
    ...
    function b(i, a, s) {
        ...
        this.selfDataUrlUpdate = "http://" + dt + ".sinajs.cn/etag.php?_=" + (new Date).getTime() + "&list=" + h + "$symbol",
        this.cb = s,
        this.df = function(t) {
            var i = [];
            if (t)
        ...
        this.loadUrlData = function() {
            ...
            this.proxyCfg.usrObj.ssl && (s = utils_util.getSUrl(s)),
            n || (l = utils_util.tUtil.gata(a.usrObj.market),
            utils_util.load(s, function() {
                var t = window[r];
                window[r] = null,
                o.urlData = {
        ...
        this.updateData = function(i, r) {
            if (i && r && !(r.length < 1)) {
                ...
                if (i = i[0]) {
                    if (s.time <= i.time)
                        for (var e = utils_util.arrIndexOf(l, i.time), h = utils_util.arrIndexOf(l, s.time), n = h; e >= n; n++)
        ...
        this.initAndCalcAll = function(i) {
            if (this.urlData) {
                ...
                !this.datas && (this.datas = []),
                utils_util.ca(this.selfArr);
                var r, s = this.urlData.time, e = a.stock.realLen;
                0 > e && (e = o.disMod);
                var h = 0;
                for (r = 0; r <= o.disMod && !(r > e); r++)
                    s[r] ? (i[4][r].ewi = s[r].ewi,
                    h = r) : i[4][r].ewi = s[h].ewi;
    ...
    function EXPMA(i, a) {
        ...
        this.initAndCalcAll = function(i) {
            ...
            this.datas ? utils_util.ca(this.datas) : this.datas = [],
            utils_util.ca(this.selfArr);
            for (var a = l(r, this.tkProp.close), s = [], e = 0, h = this.customArr.length; h > e; e++)
    ...
    function _(i, a, s) {
        ...
        this.initAndCalcAll = function(i, r) {
            ...
            this.urlData)) {
                ...
                for (var s, e = utils_util.kUtil.adbd(a, i, !1, !0), h = 0, o = i.length; o > h; h++)
                    s = e[h],
                    this.selfArr.push({
        ...
        this.draw = function(t, r) {
            ...
            this.datas) {
                ...
                for (var s, e, h, o, l = this.datas.length, n = i.DIMENSION.w_k / Math.max(l, i.PARAM.minCandleNum), c = this.labelMaxP / (this.labelMaxP - this.labelMinP) * this.h, d = [], f = [], u = this.customArr.length; u--; ) {
    ...
    function KFLOW(i, a, s) {
        ...
        this.drawCalc = function() {
            if (this.datas) {
                ...
                for (; this.datas.length < r; )
                    this.datas.push({});
                var a, s, e = Number.MAX_VALUE, h = -Number.MAX_VALUE;
                for (a = t; i > a; a++) {
                    s = this.datas[a - t],
                    s.date = this.oriArr[a].date;
                    for (var o in this.selfArr[a])
                        this.selfArr[a].hasOwnProperty(o) && (s[o] = this.selfArr[a][o],
                        s[o] > h && (h = s[o]),
                        s[o] < e && (e = s[o]))
                }
        ...
        this.draw = function(t, r) {
            ...
            this.datas) {
                var a = this.line;
                a.clear(!0, i.PARAM.getHd());
                for (var s, e, h, o, l, n = this.datas.length, c = i.DIMENSION.w_k / Math.max(n, i.PARAM.minCandleNum), d = "hollow" == i.datas.candle, f = .6 * c, u = .5 * this.h, p = 0; 2 > p; p++) {
                    for (l = 0 == p ? i.COLOR.K_FALL : i.COLOR.K_RISE,
                    e = this.__iOffsetX - c,
                    a.beginPath(),
                    s = 0; n > s; s++)
                        o = this.datas[s],
    ...
    function KKFLOW(i, a, s) {
        ...
        this.drawCalc = function() {
            if (this.datas) {
                ...
                for (; this.datas.length < r; )
                    this.datas.push({});
                var a, s, e = Number.MAX_VALUE, h = -Number.MAX_VALUE, o = {};
                for (a = t; i > a; a++) {
                    s = this.datas[a - t],
                    s.date = this.oriArr[a].date;
                    for (var l in this.selfArr[a])
                        this.selfArr[a].hasOwnProperty(l) && ("bar" === l ? s[l] = this.selfArr[a][l] : (!o[l] && (o[l] = 0),
    ...
    function KGSTRADE(i, a, s) {
        ...
        this.df = function(t) {
            if (t && t.result && t.result.data) {
                for (var i, r = [], a = t.result.data, s = 0, e = a.length; e > s; s++)
                    i = a[s],
                    r.push({
                        date: lt.sd(i.dt),
                        buy: i.buy,
        ...
        this.draw = function(t, r) {
            ...
            this.datas) {
                var a = this.line
                  , s = a.getG();
                a.clear(!0, i.PARAM.getHd());
                for (var e, h, o, l, n, c, d = this.datas.length, f = i.DIMENSION.w_k / Math.max(d, i.PARAM.minCandleNum), u = "hollow" == i.datas.candle, p = .3 * f, v = .5 * this.h, A = 0; 2 > A; A++) {
                    for (c = this.customArr[A].color,
                    h = this.__iOffsetX - .96 * f,
                    s.textAlign = "center",
                    a.beginPath(),
                    e = 0; d > e; e++)
                        n = this.datas[e],
                        ...
                        s.fillText(n.buy, h + .3 * f, v + 12)),
                        h += f) : (h += .47 * f,
                        n.sell && (l = n.selly,
                        a.drawVStickRect(h, v, p, v - l, c, !0),
                        s.fillText(n.sell, h + .3 * f, v - 2)),
                        h += .53 * f);
                    a.stroke()
                }
                a.beginPath(),
    ...
    function SUNSPOT(i, a, s) {
        ...
        this.drawCalc = function() {
            if (this.datas) {
                ...
                for (; this.datas.length < r; )
                    this.datas.push({});
                var a, s, e = 0, h = -Number.MAX_VALUE;
                for (a = t; i > a; a++) {
                    s = this.datas[a - t],
                    s.date = this.oriArr[a].date,
        ...
        this.draw = function(t, r) {
            ...
            this.datas) {
                var a = this.line;
                a.clear(!0, i.PARAM.getHd());
                for (var s, e, h, o, l, n = this.datas.length, c = i.DIMENSION.w_k / Math.max(n, i.PARAM.minCandleNum), d = "hollow" == i.datas.candle, f = ["#FF6655", "#8cdaff"], u = .2 * c, p = this.h, v = 0; 3 > v; v++)
                    for (l = f[v],
                    e = this.__iOffsetX - c,
                    ...
                    s = 0; n > s; s++)
                        ...
                        2 > v)
                            o.bar && (h = o.bary,
                            0 == v && o.percent >= 0 ? a.drawVStickRect(e + .38 * c, h, u, p - h, l, !d) : 1 == v && o.percent < 0 && a.drawVStickRect(e + .38 * c, h, u, p - h, l, !d)),
                            e += c;
                        else if (2 == v) {
                            if (o.dot) {
                                var A = o.dot;
    ...
    function LB(i, a) {
        ...
        this.initAndCalcAll = function(i) {
            ...
            for (var r, a, s = 0, e = i.length, h = 0; e > s; s++) {
                ...
                for (var o = 0, l = 0; o < this.disMod; o++) {
                    ...
                    l++) : h = o == this.disMod - 1 ? r / a / (o - l) : r / a / (o - l + 1),
                    0 > h && (h = 0),
                    this.selfArr.push({
        ...
        this.draw = function(t) {
            if (this.datas) {
                this.line.clear(!0, this.cfg.PARAM.getHd());
                for (var i, r = this.datas.length, a = this.cfg.DIMENSION.w_t / r, s = this.customArr.length; s--; ) {
    ...
    function MA(i, a) {
        ...
        this.initAndCalcAll = function(i) {
            ...
            this.datas ? utils_util.ca(this.datas) : this.datas = [],
            utils_util.ca(this.selfArr);
            for (var a = this.tkProp.close, s = r.length, e = 0, h = this.customArr.length; h > e; e++)
                for (var l, n = 0, c = Math.floor(this.customArr[e].v), d = 0; s > d; d++) {
                    var f = r[d];
                    if (n += Number(f[a]),
                    d >= c - 1) {
                        l = n / c;
    ...
    function MACD(i, a) {
        ...
        this.draw = function(t, r) {
            ...
            this.datas) {
                ...
                var o, l;
                "k" == a.type ? (o = i.DIMENSION.w_k,
                l = i.PARAM.minCandleNum) : (o = i.DIMENSION.w_t,
                l = 1);
                for (var n, c, d = this.datas.length, f = o / Math.max(d, l), u = "k" == a.type ? this.__iOffsetX - f * mt : f * gt, p = 0; 2 > p; p++) {
                    var v = this.customArr[p].prop + "y";
                    for (c = u,
                    this.line.newStyle(this.customArr[p].color, !0, 1.3),
                    n = 0; d > n; n++)
                        0 == n ? this.line.moveTo(c, this.datas[n][v]) : this.line.lineTo(c, this.datas[n][v]),
                        c += f;
                    this.line.stroke()
                }
    ...
    function OBV(i, a) {
        ...
        this.initAndCalcAll = function(i) {
            ...
            !this.datas && (this.datas = []),
            utils_util.ca(this.selfArr);
            var r, a, s, e = this.customArr[0].v, h = i[0];
            ...
            for (var o = 1, l = i.length; l > o; o++) {
                ...
                n.obv = r,
                a += r,
                o >= e ? (a -= this.selfArr[o - e].obv,
                n.obvma = a / e) : n.obvma = a / (o + 1)
            }
        }
    }
    ...
    function P(t, i, a) {
        ...
        this.draw = function() {
            if (this.datas) {
                ...
                for (var r, a, s, e, h = this.datas.length, o = t.DIMENSION.w_k / Math.max(h, t.PARAM.minCandleNum), l = this.labelMaxP / (this.labelMaxP - this.labelMinP) * this.h, n = [], c = [], d = this.customArr.length; d--; ) {
        ...
        var e, h = "ff.sinajs.cn", o = {
            ...
            var i, r, a = t["2cn_" + s.symbol].split(","), e = 65;
            for (i = 0; 10 > i; i++)
                r = l[i] || {},
                l[i] = r,
                r.v = a[e - i],
    ...
    function PSY(i, a) {
        ...
        this.initAndCalcAll = function(i) {
            ...
            for (var n = [e], c = 1, d = i.length; d > c; c++) {
                ...
                f.psy = o,
                l += o,
                c >= a ? (l -= this.selfArr[c - a].psy,
                f.psyma = l / a) : f.psyma = l / (c + 1)
            }
        }
    }
    function E(i, a, s) {
                ...
                if (i = i[0]) {
                    if (s.time < i.time)
                        for (var e = utils_util.arrIndexOf(l, i.time), h = utils_util.arrIndexOf(l, s.time), n = h; e >= n; n++)
                            ...
                            console.log(e, n, a.stock.realLen)) : r[r.length - 1] = i;
                    else
        ...
        this.createPlayingData = function() {
            if (this.datas) {
                ...
                for (var i, r = this.labelMaxP - this.labelMinP, a = 0, s = this.datas.length; s > a; a++) {
                    i = this.datas[a];
    ...
    function SAR(i, a) {
        ...
        this.setRange = function() {
            if (this.datas) {
                ...
                for (; this.datas.length < r; )
                    this.datas.push({});
                for (var a = Number.MAX_VALUE, h = -Number.MAX_VALUE, o = 0, l = 0, n = this.selfArr[t].ignore_minmax, c = t; i > c; c++) {
                    var d = this.oriArr[c]
        ...
        this.draw = function(t, r) {
            ...
            this.datas) {
                ...
                var s = this.datas.length
                  ...
                  , h = Math.max(.1 * e, .1);
                h > 2 && (h = 2);
                for (var o, l = this.__iOffsetX - e * mt, n = this.customArr[0].prop + "y", c = this.customArr, d = 0; 2 > d; d++) {
                    o = l,
                    this.line.newStyle(0 == d ? c[2].color : c[1].color, !0, 2);
                    for (var f = 0; s > f; f++)
                        this.datas[f].ignore_minmax == d && this.line.drawDot(o, this.datas[f][n], h, !0),
                        o += e;
                    this.line.stroke()
                }
    ...
    function TTOPTRADE(i, a, s) {
        ...
        this.generateSettings = function() {
            if (h.param && h.param.length > 0) {
                ...
                for (var i = 0, r = h.param.length; r > i; i++)
                    h.customArr.push({
                        vol: 0 / 0,
                        color: h.param[i].color || o[i].color || "#" + utils_util.randomColor(),
                        prop: o[i].prop,
                        idct: o[i].idct
                    })
            }
        ...
        this.loadUrlData = function() {
            if (a.stock.hq) {
                var i = this.aliasymbol || this.symbol
                  ...
                  , s = this.selfDataUrl.replace("$symbol", i).replace("$cb", "var%20" + r + "=").replace("$rn", String((new Date).getDate()));
                this.proxyCfg.usrObj.ssl && (s = utils_util.getSUrl(s)),
                d || (c = utils_util.tUtil.gata(a.usrObj.market),
                utils_util.load(s, function() {
                    var t = window[r];
                    h.urlData = {
                        time: []
        ...
        this.draw = function(t) {
            ...
            this.datas) {
                ...
                for (var a, s, e, h, o, l = this.datas.length, n = i.DIMENSION.w_t / l, c = 0, d = .6 * n, f = .5 * this.h, u = 0; 2 > u; u++) {
                    switch (c) {
                    case 0:
                        o = i.COLOR.T_RISE;
                        break;
                    ...
                    a = 0; l > a; a++)
                        h = this.datas[a],
                        e = h.trade_totaly,
                        h.trade_total > 0 && (h.trade_buy > 0 && r.drawVStickC(s, e, d, f - e, o),
    ...
    function TFLOW(i, a, s) {
        ...
        this.generateSettings = function() {
            ...
            if (e.param && e.param.length > 0) {
                ...
                for (var r = 0, a = e.param.length; a > r; r++)
                    e.customArr.push({
                        v: 0 / 0,
                        color: e.param[r].color || c[r].color || "#" + utils_util.randomColor(),
                        prop: c[r].prop,
                        idct: c[r].idct
                    })
            }
        ...
        this.loadUrlData = function(i) {
            if (i && a.stock.hq) {
                ...
                a.stock.hq.isUpdateTime || (clearInterval(this.updateId),
                this.updateId = null),
                utils_util.load(e.selfDataUrl.replace("$symbol", r).replace("$cb", "var%20" + s + "="), function() {
                    var t = window[s];
                    return t && t.__ERROR ? (e.urlData[4] = d,
                    void (n = 1)) : void (t && (o ? e.urlData[4] = f(t) : e.urlData = e.df(t),
                    d = e.urlData[4],
                    e.toReCalc = !0,
                    e.cb(e),
        ...
        ,
        this.initAndCalcAll = function(i) {
            if (a.stock.hq && l && (e.loadUrlData(!0),
            l = !1),
            this.oriArr = this.gdsd(i),
            1 != n && this.urlData) {
                !this.datas && (this.datas = []),
                utils_util.ca(this.selfArr);
                var r, s, h = i.length, o = [], c = this.urlData.length, d = 0;
                for (r = 0; h > r; r++)
                    for (s = d; c > s; s++)
                        i[r][0] && i[r][0].date && this.urlData[r][0] && utils_util.dateUtil.ds(i[r][0].date, "-") == this.urlData[r][0].date ? (d++,
                        o.push(this.urlData[s])) : s >= c - 1 && o.push([]);
                for (r = 0; h > r; r++)
                    for (var f, u, p = r >= h - 1 ? 1e-7 : 1e-6, v = 0; v < this.disMod; v++) {
                        u = i[r][v],
        ...
        this.draw = function(t) {
            if (this.datas) {
                ...
                for (var r, s = this.datas.length, o = this.cfg.DIMENSION.w_t / s, l = this.customArr.length; l--; ) {
    ...
    function TZY(i, a, s) {
        ...
        var o = "dkfz_";
        this.selfDataUrlUpdate = "http://" + dt + ".sinajs.cn/etag.php?_=" + (new Date).getTime() + "&list=" + o + "$symbol",
        this.cb = s,
        this.toReCalc = !0,
        this.loadedFlag = {},
        this.loadedFromTo = void 0,
        ...
        this.setRange = function() {
            if (this.datas) {
                ...
                for (; this.datas.length < r; )
                    this.datas.push({});
                for (var a = 0, s = 0, o = this.selfArr[t].flag, l = bt.calcA, n = bt.getArr, c = 10, d = t; i > d; d++) {
                    var f = this.datas[d - t];
                    f.date = this.oriArr[d].date;
                    var u = this.selfArr[d].flag
                      , p = this.oriArr[d]
                      , v = l(n(this.oriArr.slice(0 > d - c + 1 ? 0 : d - c + 1, d + 1), "close", function(t) {
                        return +t.toFixed(2)
                    }))
                      , A = p.close.toFixed(2)
                      , m = p.open.toFixed(2);
                    if (d != t) {
                        ...
                        1 == u && (a = m > v ? ((A - m) / m + 1) * (1 + a) - 1 : ((A - v) / v + 1) * (1 + a) - 1);
                    o = u,
        ...
        this.draw = function(r, a) {
            ...
            this.datas) {
                ...
                var l, n, c, d = this.viewState.start, f = this.viewState.end, u = utils_util.hex2dec(this.customArr[0].color, .5), p = utils_util.hex2dec(this.customArr[1].color, .5);
                c = d,
                n = this.datas[0].flag;
                for (var v = d; f > v; v++)
                    if (this.datas[v - d].isFake && v != f - 1)
                        c = v;
                    else {
                        if (l = this.datas[v - d].flag,
                        l != n) {
                            o.beginPath();
                        ...
                        (v == f - 1 && !this.datas[v - d].isFake || v == f - 2 && this.datas[v - d + 1].isFake) && (o.beginPath(),
                        A = this.oriArr[v].ix,
                        m = this.oriArr[v].cy,
                        l != n ? (g = (this.oriArr[v].ix + this.oriArr[v - 1].ix) / 2,
                        b = (this.oriArr[v].cy + this.oriArr[v - 1].cy) / 2,
                        o.moveTo(A, m),
                        o.lineTo(g, b),
                        1 == l ? (o.lineTo(this.oriArr[v].ix, this.oriArr[v].hy),
                        _ = this.oriArr[v].cy == this.oriArr[v].hy,
                        _ ? o.newStyle([u]) : o.newFillStyle([u])) : (o.lineTo(this.oriArr[v].ix, this.oriArr[v].ly),
                        _ = this.oriArr[v].cy == this.oriArr[v].ly,
                        _ ? o.newStyle([p]) : o.newFillStyle([p]))) : (d == c ? (g = this.oriArr[c].ix,
                        b = this.oriArr[c].cy) : (g = (this.oriArr[c].ix + this.oriArr[c - 1].ix) / 2,
                        b = (this.oriArr[c].cy + this.oriArr[c - 1].cy) / 2),
                        o.moveTo(A, m),
                        o.lineTo(g, b),
                        1 == l ? (y = s(this.oriArr.slice(c, v + 1), "high", !0) + c,
                        o.lineTo(this.oriArr[y].ix, this.oriArr[y].hy),
                        _ = this.oriArr[v].cy == this.oriArr[y].hy,
                        _ ? o.newStyle([u]) : o.newFillStyle([u])) : (y = s(this.oriArr.slice(c, v + 1), "low", !1) + c,
                        o.lineTo(this.oriArr[y].ix, this.oriArr[y].ly),
                        _ = this.oriArr[v].cy == this.oriArr[y].ly,
                        _ ? o.newStyle([p]) : o.newFillStyle([p]))),
                        _ ? o.stroke() : o.fill()),
    ...
    function TZYS(t, i, r) {
        ...
        this.drawCalc = function() {
            if (this.datas) {
                this.setRange();
                var t, i, r, a, s = this.datas.length, e = Number.MAX_VALUE, h = -Number.MAX_VALUE;
                for (i = 0; s > i; i++)
                    for (t = this.datas[i],
                    r = this.customArr.length; r--; )
        ...
        this.draw = function(t, i) {
            ...
            this.datas) {
                ...
                for (var a, s = this.datas.length, e = this.cfg.DIMENSION.w_k / Math.max(s, this.cfg.PARAM.minCandleNum), h = this.customArr.length; h--; ) {
                    ...
                    this.line.newStyle(this.customArr[h].color, !0, 1.5);
                    for (var l = 0; s > l; l++)
                        0 == l ? this.line.moveTo(a, this.datas[l][o]) : this.line.lineTo(a, this.datas[l][o]),
                        a += e;
                    this.line.stroke()
                }
                t && this.line.drawBg(this.__iOffsetX)
    ...
    function VR(i, a) {
        ...
        var s = bt.calcMA
          ...
          , l = bt.operateArr;
        this.initAndCalcAll = function(i) {
            for (var r = this.gdsd(i), a = this.customArr[0].v, n = this.customArr[1].v, c = o(r, this.tkProp.close), d = o(r, "volume"), f = h(c, 1), u = [], p = [], v = [], A = 0, m = c.length; m > A; A++)
    ...
    function VOLUME(i, a) {
        ...
        this.initAndCalcAll = function(i) {
            ...
            !this.datas && (this.datas = []),
            utils_util.ca(this.selfArr);
            for (var r = s.name.toLowerCase(), a = i.length, h = 0, o = this.customArr.length; o > h; h++)
        ...
        this.drawCalc = function() {
            if (this.datas) {
                for (var i = this.viewState.start, r = this.viewState.end, a = r - i; this.datas.length > a; )
                    this.datas.length--;
                for (; this.datas.length < a; )
                    this.datas.push({});
                var s, e, h = -Number.MAX_VALUE, o = 0;
                for (s = i; r > s; s++) {
                    e = this.datas[s - i],
        ...
        this.draw = function(t, r) {
            ...
            this.datas) {
                var a = this.line;
                a.clear(!0, i.PARAM.getHd());
                for (var s, e, h, o, l = this.datas.length, n = i.DIMENSION.w_k / Math.max(l, i.PARAM.minCandleNum), c = this.h, d = .6 * n, f = "hollow" == i.datas.candle, u = 0; 2 > u; u++) {
                ...
                for (var v = 1, A = this.customArr.length; A > v; v++) {
                    ...
                    for (var g = 0; l > g; g++)
                        0 == g ? a.moveTo(s, this.datas[g][m]) : a.lineTo(s, this.datas[g][m]),
                        s += n;
                    a.stroke()
                }
                a.drawBg(this.__iOffsetX)
    ...
    function TVOL(cfg, at) {
        ...
        this.initAndCalcAll = function(i) {
            ...
            !this.datas && (this.datas = []),
            utils_util.ca(this.selfArr);
            for (var a = s.name.toLowerCase(), h = r.length, o = 0, l = this.customArr.length; l > o; o++)
        ...
        this.drawCalc = function() {
            if (this.datas) {
                for (var i = this.viewState.start * this.disMod, r = this.viewState.end * this.disMod, a = r - i; this.datas.length > a; )
                    this.datas.length--;
                for (; this.datas.length < a; )
                    this.datas.push({});
        ...
        this.draw = function() {
            if (this.datas) {
                ...
                for (var r, a, s, e, h = this.datas.length, o = cfg.DIMENSION.w_t / h, l = this.h, n = o * gt, c = -1, d = 0; 3 > d; d++) {
                    switch (c) {
                    case -1:
                        e = cfg.COLOR.T_FALL;
                        break;
    ...
    function pChart(i) {
        ...
        var a, s = i.stockData, e = i.iMgr, o = i.titleArea, l = i.chartArea, c = i.cb, d = i.cfg, p = i.type, v = i.usrObj, m = [], g = {
            edit: function(t) {
                a.createChart(t)
            },
            remove: function(t) {
            ...
            if (d.custom.allow_indicator_edit)
                if (tt)
                    ...
                    v.ssl && (a = utils_util.getSUrl(a, !0)),
                    tt = new Q({
                        url: a,
                        z: 10001
                    },at(w, null, i, r))
                ...
                if (s) {
                    ...
                    if (techName) {
                        ...
                        if (!h) {
                            ...
                            if (!utils_util.isFunc(chartf))
                                return;
                            chartf === BLANKCTN && r ? (h = r,
                            h.wrap.style.display = "") : (h = new chartf(cfg,At,f),
                            chartf === BLANKCTN && (r = h)),
    ...
    function Q(i, r) {
        ...
        a(h, e);
        var o, l, n, c, d = 250, f = 0, u = 80, p = 35, v = 25;
        ...
        this.show = function(i) {
            if (o) {
                ...
                a = i.changedTouches[0].clientY) : (r = i.clientX,
                a = i.clientY);
    ...
    var tt, it = utils_util.oc, rt = utils_util.$C, at = utils_util.fBind, st = utils_util.xh5_EvtUtil, et = utils_painter.xh5_ibPainter, ht = utils_painter.xh5_Canvas, ot = utils_util.xh5_PosUtil, lt = utils_util.dateUtil, nt = utils_util.bridge, ct = utils_util.colorPicker, dt = utils_util.HQ_DOMAIN, ft = ["VOLUME", "MACD", "KDJ", "RSI", "BOLL", "WR", "BBIBOLL", "SAR", "DMI", "EMV", "ROC", "PSY", "OBV", "WVAD", "CCI", "TRIX", "DMA", "EXPMA", "BIAS", "ASI", "VR", "BRAR"], ut = ["TVOL", "LB", "MACD", "BOLL", "RSI", "BBIBOLL", "ROC", "TRIX", "DMA", "EXPMA", "BIAS", "VR"], pt = {}, vt = "ignore_", At = vt + "istpre", mt = .4, gt = .5;
    techchart.prototype = {
        storageVer: "v1",
    ...
    techchart.prototype.mr = function() {
        ...
        var a, s = this, e = this.proxyCfg.initMgr.innerResize, h = .1, o = 40, l = void 0, n = function(t) {
            st.preventDefault(t);
            ...
            utils_util.xh5_deviceUtil.istd ? (st.addHandler(l, "touchend", c),
            st.addHandler(l, "touchmove", n)) : (st.addHandler(window, "mouseup", c),
            st.addHandler(window, "mousemove", n),
            utils_util.xh5_deviceUtil.allowt && (st.addHandler(l, "touchend", c),
            ...
            utils_util.xh5_deviceUtil.istd ? st.addHandler(l, "touchstart", d) : (st.addHandler(l, "mousedown", d),
            utils_util.xh5_deviceUtil.allowt && st.addHandler(l, "touchstart", d),
    ...
    techchart.prototype.rab = function() {
        ...
        var a = this
          ...
          , o = function() {
            ...
            utils_util.xh5_deviceUtil.istd ? st.addHandler(e, "touchend", h) : (st.addHandler(e, "click", h),
            utils_util.xh5_deviceUtil.allowt && st.addHandler(e, "touchend", h),
    ...
    techchart.prototype.ic = function(i) {
        ...
        for (var a in this.proxyCfg.style)
            this.proxyCfg.style.hasOwnProperty(a) && (this.wrap.style[a] = this.proxyCfg.style[a]);
        if (this.proxyCfg.titleCtn)
            ...
            var s = this;
            if (st.addHandler(this.titleCtn, "touchstart", function(t) {
    ...
    techchart.prototype.loadUrlData = function() {
        ...
        if (i) {
            ...
            utils_util.load(h, function() {
                ...
                var l, n, c = [], d = [], f = a.length, u = a[0], p = {}, v = {}, A = {};
                for (l = o.customArr.length; l--; )
                    A[o.customArr[l].prop] = void 0;
                A.date = void 0;
                for (n in A)
                    A.hasOwnProperty(n) && (utils_util.isDate(u[n]) ? (p[n] = u[n],
                    v[n] = u[n]) : (p[n] = 1 * u[n],
                    v[n] = 1 * u[n]));
                if (1 == f)
                    c.push(p),
                    ...
                    for (l = 1; f > l; l++) {
                        u = a[l],
                        lt.gw(a[l - 1].date, u.date) || (c.push(p),
                        p = {});
                        for (n in A)
                            A.hasOwnProperty(n) && (p[n] = utils_util.isDate(u[n]) ? u[n] : (1 * p[n] || 0) + 1 * u[n]);
                        lt.gm(a[l - 1].date, u.date) || (d.push(v),
                        v = {});
                        for (n in A)
                            A.hasOwnProperty(n) && (v[n] = utils_util.isDate(u[n]) ? u[n] : (1 * v[n] || 0) + 1 * u[n])
                    }
                    c.push(p),
                    d.push(v)
                }
    ...
    techchart.prototype.newData = function(t, i, r) {
        if (t && !(t.length < 1)) {
            var a = t[t.length - 1];
            if (168 == r && lt.gw(a.date, i.date) || 720 == r && lt.gm(a.date, i.date))
    ...
    techchart.prototype.createPlayingData = function() {
        if (this.datas)
            for (var t, i = this.labelMaxP - this.labelMinP, r = 0, a = this.datas.length; a > r; r++) {
                t = this.datas[r];
    ...
    techchart.prototype.generateSettings = function() {
        if (this.param && this.param.length > 0)
            for (var i = 0, r = Math.min(this.param.length, this.DEFAULT_ARR.length); r > i; i++) {
                ...
                this.customArr[i].color = utils_util.isColor(a.color) ? a.color : this.DEFAULT_ARR[i].color
            }
    }
    ,
    ...
    techchart.prototype.draw = function(t, i) {
        ...
        this.datas) {
            ...
            this.cfg.datas.isT ? (r = this.cfg.DIMENSION.w_t / s,
            a = r * gt) : (r = this.cfg.DIMENSION.w_k / Math.max(s, this.cfg.PARAM.minCandleNum),
    ...
    techchart.prototype.drawValueRange = function() {
        ...
        if (!isNaN(this.vaObj.upper) && !isNaN(this.vaObj.lower)) {
            var e = this.vaObj.upper
              ...
              , l = this.h * (a - h) / s
              , n = l - o;
            i.fillStyle = utils_util.hex2dec(this.customArr[0].color, .2),
    ...
    techchart.prototype.genTitleCanvas = function(i) {
        function r() {
            ...
            this.setTxt = function(r) {
                ...
                var y = 1;
                if (r) {
                    for (var _, w, D, M = l + (v > 0 ? d : 0), O = [], S = r.length, T = 0; S > T; T++)
                        if (_ = r[T],
                        _.t || !isNaN(_.n)) {
                            switch (w = (_.t ? _.t + ": " : "") + (isNaN(_.n) ? "--" : utils_util.strUtil.ps(_.n, h.nfloat)),
                            s.name) {
                            case "TFLOW":
                                T == r.length - 1 && (w += "\u5143");
                                break;
                    ...
                    c(M, b)) : (c(M, b),
                    s.cfg.DIMENSION.H_T_T > u - 1 && (a.textAlign = "right",
                    a.fillStyle = s.cfg.COLOR.T_T,
                    a.fillText(i, l, y)),
                    I = l + (v > 0 ? d : 0)),
                    a.textAlign = "left";
                    for (var C = I, R = 0, k = O.length; k > R && (_ = O[R],
                    a.fillStyle = _.color,
                    a.fillText(_.str, I, y),
                    I += _.w + f,
                    !(R >= k - 1)); R++)
                        I - l + O[R + 1].w > n && (y += s.cfg.STYLE.FONT_SIZE,
                        I = C)
                } else
        ...
        function a() {
            ...
            r.appendChild(e);
            var o = r.style;
            utils_util.isFunc(s.proxyCfg.onClkTT) && (utils_util.xh5_deviceUtil.istd ? st.addHandler(r, "click", at(s.proxyCfg.onClkTT, null, s)) : (st.addHandler(r, "click", at(s.proxyCfg.onClkTT, null, s)),
            utils_util.xh5_deviceUtil.allowt && st.addHandler(r, "touchend", at(s.proxyCfg.onClkTT, null, s))),
            o.cursor = "pointer",
            o.position = "relative",
            ...
            this.setTxt = function(r) {
                ...
                if (r) {
                    f ? (a.innerHTML = "",
                    s.cfg.DIMENSION.H_T_T < 2 && (e.style.marginLeft = "50px")) : a.innerHTML = s.cfg.DIMENSION.H_T_T > 1 ? u : "",
                    e.innerHTML = "";
                    for (var p, v, A, m = 0, g = r.length; g > m; m++)
                        ...
                        v.t || !isNaN(v.n)) {
                            ...
                            case "SAR":
                                if ("SAR" == s.name) {
                                    if (!s.asPChart && "SAR" != v.t)
                                        continue
                                } else if ("DPDKS" == s.name && "mn" == v.t)
                                    continue;
                            ...
                            case "MA":
                                ...
                                break;
                            case "SUNSPOT":
                                A = "SUNSPOT" === v.t ? v.n ? (v.t ? v.t + ": " : "") + (isNaN(v.n) ? "--" : utils_util.strUtil.ps(v.n, 0)) + "\u7ea7" : "" : (v.t ? v.t + ": " : "") + (isNaN(v.n) ? "--" : utils_util.strUtil.ps(v.n, h.nfloat));
                                break;
                            default:
                                A = (v.t ? v.t + ": " : "") + (isNaN(v.n) ? "--" : utils_util.strUtil.ps(v.n, h.nfloat)),
    ...
    techchart.prototype.rfs = function() {
        this.selfCfg.allowrfs ? (this.titleO && utils_util.domGc(this.titleO.canvas),
        ...
        var r = Object.prototype.toString
            ...
            function s(t) {
                if (!(t >= n))
                    ...
                    c[t] > l[t])
                        ...
                        for (f[t] = Math.max.apply(null, o.slice(t - i + 1, t + 1)),
                        d[t] = r; n - 1 > t; ) {
                            if (c[t + 1] = c[t] + d[t] * (f[t] - c[t]) / 100,
                            u[t + 1] = 1,
                            c[t + 1] > l[t + 1])
                                return void e(t + 2);
                            f[t + 1] = Math.max.apply(null, o.slice(t - i + 2, t + 2)),
                            o[t + 1] > f[t] ? (d[t + 1] = d[t] + r,
                            d[t + 1] > a && (d[t + 1] = a)) : d[t + 1] = d[t],
                            t++
                        }
            }
            function e(t) {
                if (!(t >= n)) {
                    ...
                    c[t] < o[t])
                        return void s(t + 1);
                    for (f[t] = Math.min.apply(null, l.slice(t - i + 1, t + 1)),
                    d[t] = r; n - 1 > t; ) {
                        if (c[t + 1] = c[t] + d[t] * (f[t] - c[t]) / 100,
                        u[t + 1] = 0,
                        c[t + 1] < o[t + 1])
          ...
          , v = function(t, i) {
            for (var r = [], a = 0, s = t.length; s > a; a++)
                r.push(i > a ? p(t.slice(0, a + 1), 1) : p(t.slice(a - i + 1, a + 1), 1));
            return r
        }
          , A = function(t) {
            for (var i = u(t), r = 0, a = t.length, s = a; s--; )
                r += e(t[s] - i);
            return r / a
        }
          , m = function(t, i) {
          ...
          , D = function(r, a, s) {
            ...
            case "Array":
                for (h = a.length,
                e = 0; l > e; e++)
                    o.push("Number" == t(r[e]) && "Number" == t(a[e]) ? i(s, r[e], a[e]) : null);
                for (; o.length < h; )
                    o.push(null);
                break;
            case "Number":
    ...
    utils_util.fInherit(o, techchart),
    ...
    utils_util.fInherit(f, techchart),
    utils_util.fInherit(u, techchart),
    ...
    utils_util.fInherit(b, techchart),
    utils_util.fInherit(EXPMA, techchart),
    utils_util.fInherit(_, techchart),
    ...
    utils_util.fInherit(P, techchart),
    utils_util.fInherit(PSY, techchart),
    utils_util.fInherit(E, techchart),
        ...
        var i = function(t) {
            var i = function() {
                for (var t, i, r = {
                    ...
                    a: r
                }], s = document.location.href, e = a.length; e--; )
                    if (i = a[e],
                    0 === s.indexOf(i.h)) {
                        t = i.a;
                        break
    ...
    return new function() {
        ...
        this.get = function(config, callback) {
            utils_util.isFunc(callback) && callback({
                tChart: tChart,
                pChart: pChart
            })
        }
