          ...
          if (1 == a)
            ...
            for (
              ...
              C.gw(t[I - 1].date, o.date)
                ? (o.high > dHigh && (dHigh = o.high),
                  o.low < dLow && (dLow = o.low),
                  (dClose = o.close),
                  (dVolume += o.volume),
                  (dAmount += o.amount),
                  (dDate = o.date))
                : (isNaN(r) ||
                    ...
                    0 == s && (s = 7),
                    (h = s - r),
                    h > 0 && ((dDate = C.ddt(dDate)), dDate.setDate(dDate.getDate() - h))),
                  l.push({
                    open: dOpen,
                    high: dHigh,
                    low: dLow,
              ...
              C.gm(t[I - 1].date, o.date)
                ? (o.high > mHigh && (mHigh = o.high),
                  o.low < mLow && (mLow = o.low),
                  (mClose = o.close),
                  (mVolume += o.volume),
                  (mAmount += o.amount),
                  (mDate = o.date))
                : (isNaN(r) ||
                    ...
                    0 == s && (s = 7),
                    (h = s - r),
                    h > 0 && ((mDate = C.ddt(mDate)), mDate.setDate(mDate.getDate() - h))),
                  u.push({
                    open: mOpen,
                    high: mHigh,
                    low: mLow,
              ...
              C.gy(t[I - 1].date, o.date)
                ? (o.high > yHigh && (yHigh = o.high),
                  o.low < yLow && (yLow = o.low),
                  (yClose = o.close),
                  (yVolume += o.volume),
                  (yAmount += o.amount),
                  (yDate = o.date))
