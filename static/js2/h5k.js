xh5_define("datas.k", ["utils.util"], function(e) {
  ...
  return new (function() {
    ...
    var r = {
      ...
      MSCI: {
        DAYK_URL:
          "http://i.quotes.sina.cn/msci/api/jsonp.php/$cb/MSCIService.getDayLine?symbol=$symbol"
      }
    };
    r.REPO = r.CN;
    var l = function() {
    ...
    function a(a) {
      function Chart(e, n) {
        ...
        var C = new (function() {
          ...
          $ = new (function() {
            var i,
              o = function(e, n) {
                S.re(_.e.K_DATA_LOADED, n), t.isFunc(e) && e();
              },
              s = function(e) {
        ...
        (this.kDb = C),
          ...
          (this.draw = function() {
            M.draw(), y && y.allDraw(z.x), N && N.allDraw(z.x);
          }),
      ...
      function M() {
        var e,
          ...
          y = function() {
            ...
            for (var m = o; m--; ) (e = charts[m]), e.setPricePos(p, s);
          },
          N = function() {
            (V.start < 1 || !L.custom.smooth) && z.resetX();
            for (var e = charts.length; e--; ) charts[e].draw();
          },
          w = function() {
        ...
        (this.pushData = function(e, t) {
                ...
                if (i.hasOwnProperty("symbol")) {
                  for (var o = i.symbol, s = charts.length; s--; )
                    if (charts[s].symbol == o) {
                      charts[s].setLineStyle(i), charts[s].draw();
                      break;
                    }
          ...
          (this.onResize = function(e) {
            for (var t = charts.length; t--; ) charts[t].resize(e);
          });
        var ae = -1,
          ie = -1,
          oe = function(e, t) {
        ...
        (this.onWheel = function(e) {
          ...
          (this.dcReset = function() {
            ...
            for (var e, t = charts.length; t--; )
              (e = charts.splice(t, 1)[0]), e.clear(), (e = null);
          }),
      ...
      var I,
        ...
        B = new (function() {
            ...
            if (!t.e || !w) {
              ...
              if (n) {
                ...
                if (
                  ...
                  return;
                (x = D[v]), (K = D), (M = C.getName()), (y = C.symbol);
                var X = Math.abs(T);
          ...
          (this.globalDragHandler = function(e, t, n, a, i) {
            if (isNaN(e) && isNaN(t))
              return (P = 0 / 0), (M = !1), void S.re(_.e.I_EVT, i);
            g();
            var o = V.start,
              s = V.end,
              r = s - o;
            ...
            if (Math.abs(l) < h) {
              ...
              (o -= d),
                ...
                0 > o && ((o = 0), (s = r)),
                (V.start != o || V.end != s) &&
                  (z.resetX(0), (V.movY = a - n), I.moving(o, s, !0), (M = !0));
            }
          }),
            (this.shortClickHandler = function() {
              Y.shortClickHandler();
      ...
      var W = new (function() {
        ...
        this.showView = function(e, n, a) {
          ...
          if (i) {
            if ((m && w(), i == _.URLHASH.KCL)) M.enterClMode();
            else {
