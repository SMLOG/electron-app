xh5_define("plugins.sinaAppTKChart", ["utils.util"], function(t) {
  ...
  function y(t, e, i) {
    var a = document.createElement("ul"),
      r = e.more,
      n = r.length;
    c(a.style, e.subNavStyle, !0), (a.style.display = "none");
  ...
  function k(t, e, i, a) {
    var r = document.createElement("ul"),
      o = e.list,
      s = o.length;
    t.appendChild(r), (r.style.display = "none"), c(r.style, e.navTopStyle, !0);
  ...
  function L(t, e) {
    ...
    c(l, e.zoomOutStyle, !0),
      s.addEventListener("click", function(e) {
        t.chart.chart.zoom(!1), a(e), M(t, "zoom");
      }),
      i.appendChild(s),
      (this.dom = i),
  ...
  function z(t) {
    for (var e = Z.length; e--; ) if (t.match(Z[e])) return !0;
    return !1;
  }
  function F(t) {
  ...
  function O(t, e, i) {
    ...
    if (i)
      (t.tab.list = ["networth", "repay"]),
        ...
        Number(i.flashType[1]) &&
          (t.tab.list.unshift("predict"), (t.chart.initView = "predict")),
        Number(i.flashType[0]) &&
          (t.tab.list.unshift("more"), (t.chart.initView = "t1")),
      ...
      switch (a) {
        case "CN":
          m(e) &&
            ...
            (r =
              "null" === r
                ? -1
                : Number(r.replace('"rek', "").replace(/"/g, ""))),
        ...
        case "LSE":
          (t.tab.list = ["t1", "kd", "kw", "km"]),
            ...
            (t.info.toFixedNum =
              t.chart.tInitParam.ennfloat && t.chart.tInitParam.nfloat
                ? t.chart.tInitParam.nfloat
                : 3);
          break;
        case "GOODS":
          (t.tab.list = ["t1", "kd", "kw", "km"]),
        ...
        case "OTC":
          ...
          "sb899307" === e ||
          "sb899003" === e
            ? ((t.tab.list = ["kcl", "kd", "kw", "km"]),
              (t.chart.initView = "kcl"))
            : (t.tab.list = ["t1", "kcl", "kd", "kw", "km"]);
      }
    }
  }
  function U(t, e) {
    ...
    var i = t.chart.symbol,
      a = this;
    if (((this.symbol = t.chart.symbol), t.chart.isFund)) {
      var r =
  ...
  C.prototype = {
    ...
    bindClickEvent: function() {
      ...
      this.nav.addEventListener("click", function(r) {
        ...
        if (h) {
          if ((location.origin.match("touzi") && b(h), a.chart)) {
            if (!j && "app" === h) {
              switch (a.market) {
                case "CN":
            ...
            if ((a.chart.showView(h), "dk" === h))
              R(e.parent.symbol)
                ? (a.chart.chart.showKTechM("DPDK"),
                  a.chart.chart.switchKTech("DPDKS"))
                : (a.chart.chart.showKTechM("TZY"),
                  a.chart.chart.switchKTech("TZYS")),
                a.tech && a.tech.hide();
            else if (
              (a.chart.chart.hideKTechM("TZY"),
              a.chart.chart.hideKTechM("DPDK"),
              a.tech)
            )
              switch (a.chart.chart.getChartType()) {
                case "tChart":
                  a.tech.param.tChart.show && "vertical" != a.direction
                    ? (a.tech.show(), a.tech.switchTechList("tChart"))
                    : a.tech.hide();
                  break;
                case "kChart":
                  if (
                    (a.tech.param.kChart.show && "vertical" != a.direction
                      ? (a.tech.show(), a.tech.switchTechList("kChart"))
                      : a.tech.hide(),
                    "dk" === t)
                  ) {
                    var l = e.parent.tech.kChart.tCharts.querySelector(
                      "[selected=true]"
                    );
                    a.chart.chart.switchKTech(
                      l ? l.getAttribute("value") : "volume"
                    );
                  }
                  if ("k1" === h) a.chart.chart.hideKTechM("MA");
                  else {
                    var c = e.parent.tech.kChart.pCharts.querySelector(
                      "[selected=true]"
                    );
                    c &&
                      "MA" === c.getAttribute("value") &&
                      a.chart.chart.showKTechM("MA");
                  }
                  break;
                default:
                  a.tech.hide();
  ...
  (g.prototype = {
    ...
    simple: function(e) {
      ...
      if (((this.isSimple = e), e)) {
        ...
        for (var a = J.length; a--; )
          if ("k" === J[a]) {
            var r = t.isCNK(this.parent.symbol)
              ? "CNKSimpleDetailStyle"
              : "simpleDetailStyle";
            c(this.doms[J[a] + "Detail"].style, i[r], !0);
          } else c(this.doms[J[a] + "Detail"].style, i.simpleDetailStyle, !0);
      } else
        for (
          c(this.dom.style, i.completeStyle, !0),
          ...
          if ("k" === J[a]) {
            var n = t.isCNK(this.parent.symbol)
              ? "CNKCompleteDetailStyle"
              : "completeDetailStyle";
            c(this.doms[J[a] + "Detail"].style, i[n], !0);
          } else c(this.doms[J[a] + "Detail"].style, i.completeDetailStyle, !0);
    },
    _initDoms: function() {
      function t(t, a) {
        var h = r("div");
      ...
      if ((isNaN(n) && (n = 0), "tChart" == t)) {
        ...
        this._displayNoneExcept("netWorth"),
          ...
          i.length > 1 &&
            ((a.childNodes[0].innerHTML = w(
              i[0].name,
              i[0].data.close.toFixed(h.toFixedNum)
            )),
            (a.childNodes[1].innerHTML = w(
              i[1].name,
              i[1].data.close.toFixed(h.toFixedNum)
            )));
      else if ("repayChart" === t) {
        this._displayNoneExcept("repay"), (a = this.doms.repayDetail);
        var S = "";
        this.parent.tab.param.viewMap &&
          this.parent.tab.param.viewMap.repay &&
          (S = this.parent.tab.param.viewMap.repay),
          (a.childNodes[0].innerHTML = w(
            S || "\u5386\u53f2\u56de\u62a5",
            e.close.toFixed(h.toFixedNum)
          ));
      } else
        "predictChart" === t &&
          (this._displayNoneExcept("predict"),
          ...
          (a.childNodes[1].innerHTML = w(
            "\u5747",
            isNaN(e.avg_price) ? "-" : e.avg_price.toFixed(o),
            e.avg_price > r ? l : e.avg_price < r ? c : d
          )),
          (a.childNodes[2].innerHTML = w(
            "\u5e45",
    ...
    _showSimple: function(t, e) {
      ...
      t.interacting
        ? ((this.dom.style.display = "block"),
          this._showDetailInfo(e, i, t.data_array))
    ...
    _showComplete: function(t, e) {
      var i,
        ...
        h = this.doms.name,
        o = t.data,
        s = this.parent.chart.param.isFund;
